...
options {
    superClass = 'com.quasar.dorm.query.parser.AbstractQueryParser';
}

@header {
package com.sirius.dorm.query.parser;
/**
...
import com.sirius.dorm.query.QueryManager;
import com.sirius.dorm.query.Query;
import com.sirius.dorm.DataObject;
import com.sirius.dorm.model.ObjectDescriptor;
import com.sirius.dorm.query.*;
}
